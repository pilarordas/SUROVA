function calculateRisk() {
    ...
    const survivalMessage = medianSurvival 
        ? `The median survival for patients with these characteristics is ${medianSurvival} months.`
        : "Less than 50% of patients in this group died during the study follow-up period.";
